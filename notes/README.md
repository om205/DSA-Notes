...
- **[Pattern triggers](pattern-triggers.md)** — 🎯 signal → technique. **Cover the topic tag before every problem and guess the pattern first.** Topic-organised practice trains execution, not selection; this is the fix. *First hit: Daily Temperatures (2026-08-22).*
